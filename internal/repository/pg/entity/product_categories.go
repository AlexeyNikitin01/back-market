...
type ProductCategory struct {
	...
	DiscountCategory int       `boil:"discount_category" json:"discountCategory" toml:"discountCategory" yaml:"discountCategory"`
...
var ProductCategoryTableColumns = struct {
	...
	DiscountCategory: "product_categories.discount_category",
...
var ProductCategoryWhere = struct {
	...
	DiscountCategory whereHelperint
	...
	DiscountCategory: whereHelperint{field: "\"product_categories\".\"discount_category\""},
...
var (
	productCategoryAllColumns            = []string{"id", "name", "discount_category", "created_at", "updated_at", "deleted_at"}
	productCategoryColumnsWithoutDefault = []string{"name", "discount_category"}
...
func (o *ProductCategory) Products(mods ...qm.QueryMod) productQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"products_product_categories\" on \"products\".\"id\" = \"products_product_categories\".\"product_id\""),
		qm.Where("\"products_product_categories\".\"product_categories_id\"=?", o.ID),
	)
...
func (productCategoryL) LoadProducts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProductCategory interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"products\".\"id\", \"products\".\"name\", \"products\".\"price\", \"products\".\"description\", \"products\".\"quantity\", \"products\".\"created_at\", \"products\".\"updated_at\", \"products\".\"deleted_at\", \"a\".\"product_categories_id\""),
		qm.From("\"products\""),
		qm.InnerJoin("\"products_product_categories\" as \"a\" on \"products\".\"id\" = \"a\".\"product_id\""),
		qm.WhereIn("\"a\".\"product_categories_id\" in ?", args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// Sets related.R.ProductCategories appropriately.
func (o *ProductCategory) AddProducts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Product) error {
	...
	for _, rel := range related {
		query := "insert into \"products_product_categories\" (\"product_categories_id\", \"product_id\") values ($1, $2)"
	...
	for _, rel := range related {
		if rel.R == nil {
			...
			rel.R.ProductCategories = append(rel.R.ProductCategories, o)
		}
	}
	return nil
}
...
// Sets o.R.ProductCategories's Products accordingly.
// Replaces o.R.Products with related.
// Sets related.R.ProductCategories's Products accordingly.
func (o *ProductCategory) SetProducts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Product) error {
	query := "delete from \"products_product_categories\" where \"product_categories_id\" = $1"
	...
	removeProductsFromProductCategoriesSlice(o, related)
	if o.R != nil {
		o.R.Products = nil
	}
...
// Sets related.R.ProductCategories.
func (o *ProductCategory) RemoveProducts(ctx context.Context, exec boil.ContextExecutor, related ...*Product) error {
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"products_product_categories\" where \"product_categories_id\" = $1 and \"product_id\" in (%s)",
...
func removeProductsFromProductCategoriesSlice(o *ProductCategory, related []*Product) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
		for i, ri := range rel.R.ProductCategories {
			if o.ID != ri.ID {
				continue
			}

			ln := len(rel.R.ProductCategories)
			if ln > 1 && i < ln-1 {
				rel.R.ProductCategories[i] = rel.R.ProductCategories[ln-1]
			}
			rel.R.ProductCategories = rel.R.ProductCategories[:ln-1]
			break
		}
	}
}
...
func (o *ProductCategory) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(productCategoryAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(productCategoryPrimaryKeyColumns) == 0 {
				return errors.New("entity: unable to upsert product_categories, could not build conflict column list")
			}

			conflict = make([]string, len(productCategoryPrimaryKeyColumns))
			copy(conflict, productCategoryPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"product_categories\"", updateOnConflict, ret, update, conflict, insert, opts...)
