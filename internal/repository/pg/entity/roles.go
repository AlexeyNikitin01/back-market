...
func (roleL) LoadUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"users\".\"id\", \"users\".\"firstname\", \"users\".\"lastname\", \"users\".\"email\", \"users\".\"login\", \"users\".\"password\", \"users\".\"haspremium\", \"users\".\"created_at\", \"users\".\"updated_at\", \"users\".\"deleted_at\", \"a\".\"role_id\""),
		qm.From("\"users\""),
