...
type User struct {
	...
	Haspremium bool      `boil:"haspremium" json:"haspremium" toml:"haspremium" yaml:"haspremium"`
...
var UserWhere = struct {
	...
	Haspremium: whereHelperbool{field: "\"users\".\"haspremium\""},
...
var (
	userAllColumns            = []string{"id", "firstname", "lastname", "email", "login", "password", "haspremium", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"firstname", "lastname", "email", "login", "password"}
	userColumnsWithDefault    = []string{"id", "haspremium", "created_at", "updated_at", "deleted_at"}
...
func (o *User) Carts(mods ...qm.QueryMod) cartQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"carts_users\" on \"carts\".\"id\" = \"carts_users\".\"cart_id\""),
		qm.Where("\"carts_users\".\"user_id\"=?", o.ID),
	)
...
func (o *User) Orders(mods ...qm.QueryMod) orderQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"users_orders\" on \"orders\".\"id\" = \"users_orders\".\"order_id\""),
		qm.Where("\"users_orders\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadCarts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"carts\".\"id\", \"carts\".\"totalprice_products\", \"carts\".\"discount\", \"carts\".\"created_at\", \"carts\".\"updated_at\", \"carts\".\"deleted_at\", \"a\".\"user_id\""),
		qm.From("\"carts\""),
		qm.InnerJoin("\"carts_users\" as \"a\" on \"carts\".\"id\" = \"a\".\"cart_id\""),
...
func (userL) LoadOrders(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"orders\".\"id\", \"orders\".\"is_paid\", \"orders\".\"address\", \"orders\".\"totalprice_products\", \"orders\".\"created_at\", \"orders\".\"updated_at\", \"orders\".\"deleted_at\", \"a\".\"user_id\""),
		qm.From("\"orders\""),
		qm.InnerJoin("\"users_orders\" as \"a\" on \"orders\".\"id\" = \"a\".\"order_id\""),
		qm.WhereIn("\"a\".\"user_id\" in ?", args...),
	)
	if mods != nil {
		mods.Apply(query)
	...
	for results.Next() {
		...
		err = results.Scan(&one.ID, &one.IsPaid, &one.Address, &one.TotalpriceProducts, &one.CreatedAt, &one.UpdatedAt, &one.DeletedAt, &localJoinCol)
		if err != nil {
...
func (o *User) AddCarts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Cart) error {
	...
	for _, rel := range related {
		query := "insert into \"carts_users\" (\"user_id\", \"cart_id\") values ($1, $2)"
...
func (o *User) SetCarts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Cart) error {
	...
	removeCartsFromUsersSlice(o, related)
	if o.R != nil {
		o.R.Carts = nil
	}
...
func (o *User) RemoveCarts(ctx context.Context, exec boil.ContextExecutor, related ...*Cart) error {
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"carts_users\" where \"user_id\" = $1 and \"cart_id\" in (%s)",
...
func removeCartsFromUsersSlice(o *User, related []*Cart) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
...
func (o *User) AddOrders(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Order) error {
	...
	for _, rel := range related {
		query := "insert into \"users_orders\" (\"user_id\", \"order_id\") values ($1, $2)"
		values := []interface{}{o.ID, rel.ID}
...
func (o *User) SetOrders(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Order) error {
	...
	removeOrdersFromUsersSlice(o, related)
	if o.R != nil {
		o.R.Orders = nil
	}
...
func (o *User) RemoveOrders(ctx context.Context, exec boil.ContextExecutor, related ...*Order) error {
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"users_orders\" where \"user_id\" = $1 and \"order_id\" in (%s)",
		strmangle.Placeholders(dialect.UseIndexPlaceholders, len(related), 2, 1),
	)
	values := []interface{}{o.ID}
	for _, rel := range related {
...
func removeOrdersFromUsersSlice(o *User, related []*Order) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
